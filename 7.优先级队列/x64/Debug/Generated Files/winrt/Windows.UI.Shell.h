...
namespace winrt::impl
{
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Shell::IFocusSessionManager)->remove_IsFocusActiveChanged(impl::bind_in(token)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Shell::IWindowTabManager)->remove_TabSwitchRequested(impl::bind_in(token)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Shell::IWindowTabManager)->remove_TabCloseRequested(impl::bind_in(token)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Shell::IWindowTabManager)->remove_TabTearOutRequested(impl::bind_in(token)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Shell::IWindowTabManager)->remove_TabThumbnailRequested(impl::bind_in(token)));
    }
